/****************************************************************************
** Meta object code from reading C++ file 'Echequier.hpp'
**
...
#include "../../Echequier/Echequier.hpp"
...
#error "The header file 'Echequier.hpp' doesn't include <QObject>."
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDisplayENDCLASS_t qt_meta_stringdata_CLASSDisplayENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 11),  // "getResponse"
        QT_MOC_LITERAL(20, 0),  // ""
        QT_MOC_LITERAL(21, 8)   // "response"
    },
    "Display",
    "getResponse",
    "",
...
void Display::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->getResponse((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
